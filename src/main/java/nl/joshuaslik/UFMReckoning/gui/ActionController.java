...
public class ActionController {
	...
	@FXML protected void handleNewGame(ActionEvent event) {
        System.out.println("Handle [New Game] event yo! Do it nao!");
    }
	
	@FXML protected void handleLoadGame(ActionEvent event) {
        System.out.println("Handle [Load Game] event yo! Do it nao!");
    }
	
	@FXML protected void handleHighscores(ActionEvent event) {
        System.out.println("Handle [Highscore] event yo! Do it nao!");
    }
	
	@FXML protected void handleExitGame(ActionEvent event) {
